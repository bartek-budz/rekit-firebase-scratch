...
export default class AuthLinkExample extends Component {
  ...
  render() {
    return (
      <div className="examples-auth-link-example">
        <ExamplesNavigation active="AuthLink"/>
        <Alert variant="primary">
          <Alert.Heading>AuthLink</Alert.Heading>
          <p>When you are signed in, <AuthLink to="auth-link-target">AuthLink</AuthLink>, redirects directly to the target location.
          ...
          <p><AuthLink signOut  to="auth-link-target">AuthLink with signOut property and target</AuthLink> redirects you to the target location after successful sign out.</p>
          <hr />
